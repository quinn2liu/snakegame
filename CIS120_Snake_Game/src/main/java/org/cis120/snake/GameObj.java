...
public abstract class GameObj {
    ...
    /* an array indicating the x and y coordinate of the game object in the
     * GameGrid, int at index 0 is x, int at index 1 is y
     */
    public int[] position;
    /**
     * Constructor
     ...
     */
    public void move(SnakeBody snake) {
        Random rand = new Random();
        int newX = (rand.nextInt(12) + 1) * 20;
        int newY = (rand.nextInt(12) + 1) * 20;
        while (sameAsHead(snake, newX, newY)) {
            newX = (rand.nextInt(12) + 1) * 20;
            newY = (rand.nextInt(12) + 1) * 20;
        }
        this.setPx(newX);
        this.setPy(newY);
        int[] newPosition = new int[2];
        newPosition[0] = newX / 20;
        newPosition[1] = newY / 20;
    ...
    public boolean sameAsHead(SnakeBody snake, int x, int y) {
        int[] headPos = snake.getHead().getPosition();
        return (x == headPos[0] && y == headPos[1]) ;
    }
